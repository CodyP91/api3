...
CREATE TABLE `quote` (
  ...
  PRIMARY KEY (`id`),
  KEY `philosopher_id` (`philosopher_id`),
  CONSTRAINT `quote_ibfk_1` FOREIGN KEY (`philosopher_id`) REFERENCES `philosopher` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'api3'
--
...
-- Dump completed on 2023-06-10 13:51:36
